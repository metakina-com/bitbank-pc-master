<template>
  <div class="market bg_main pad-15 min-hei500">
    <el-row class="min-hei500 c_fff">
      <el-col :span="4">
        <div class="widall">
          <pankou :pankou="pankou" :type="'contract'"></pankou>
        </div>
        <div class="widall">
          <chengjiao :pankou="pankou"></chengjiao>
        </div>
      </el-col>
      <el-col :span="16" class="pad-l-r-10">
        <div class="hei550 flex flex-column">
          ...
          <div style="width:100%;position:relative" class="flex1">
            ...
            <div style="top:0;width:100%;z-index:1;position:absolute;height:100%"
        ...
        <contract class="mar-t-15 pad-l-r-15 " />
      </el-col>
      <el-col :span="4" style="">
        <!-- 市场 选择交易对 -->
...
import marketRoader from "@/components/marketRoader/history.vue";
import marketCoin from "@/components/trading-center/match.vue";
...
export default {
  ...
  mounted() {
    ...
    window.MV.$emit('currentType', 'heyue');
